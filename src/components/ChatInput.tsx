    ...
    <div className="w-full max-w-3xl mx-auto px-4 pb-4 pt-1">
      ...
      <div className="relative group">
              ...
              <div 
                ...
                className={`p-2.5 rounded-xl border transition-all cursor-pointer select-none ${
                  thinkingMode === 'deep' || (deepThink && thinkingMode !== 'basic' && thinkingMode !== 'ultra')
                    ? 'bg-zinc-800/90 border-cyan-500/50 text-white shadow-[0_0_15px_rgba(6,182,212,0.15)]'
                    : 'bg-zinc-900/60 border-zinc-800 hover:border-zinc-700 hover:bg-zinc-850/50'
                }`}
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <div className="p-1 rounded-md bg-cyan-950/60 border border-cyan-500/40 text-cyan-300">
                      <BrainCircuit className="w-3.5 h-3.5" />
                    </div>
                    <span className="font-semibold text-xs text-white font-mono">
                      {t.chatInput.deepThinkingV3}
                    </span>
                    <span className="px-1.5 py-0.2 rounded text-[9px] font-mono font-bold bg-cyan-950/80 text-cyan-300 border border-cyan-500/50">
                      {t.chatInput.deepThinkingV3Badge}
                    </span>
                  </div>
                  {(thinkingMode === 'deep' || (deepThink && thinkingMode !== 'basic' && thinkingMode !== 'ultra')) && (
                ...
                <p className="text-[11px] text-zinc-400 mt-1">
                  {t.chatInput.deepThinkingV3Desc}
                </p>
              </div>
        ...
        <div className="relative rounded-2xl sm:rounded-[24px] bg-[#0c0c11]/92 border border-white/[0.09] hover:border-white/[0.15] focus-within:!border-white/35 shadow-[0_16px_48px_-8px_rgba(0,0,0,0.85),0_0_0_1px_rgba(255,255,255,0.02),inset_0_1px_0_0_rgba(255,255,255,0.1)] focus-within:shadow-[0_20px_60px_-10px_rgba(0,0,0,0.95),0_0_30px_rgba(255,255,255,0.06),inset_0_1px_0_0_rgba(255,255,255,0.18)] backdrop-blur-2xl transition-all duration-300 overflow-hidden">
          ...
          {/* Active Model Engine Capability Telemetry HUD (Shown for configured models, hidden for autonomous Nixima-0.4) */}
          {!is04 && (
            <div className="flex items-center gap-1.5 px-4 sm:px-6 pt-3 pb-1 text-[11px] font-mono select-none flex-wrap border-b border-white/[0.04]">
              ...
              <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-zinc-900/90 border border-zinc-800 text-zinc-300 shadow-sm flex-shrink-0">
                ...
                <span className="text-[9px] px-1 py-0.2 rounded font-bold uppercase bg-zinc-800 text-zinc-400 border border-zinc-750">
                  {currentModel.generation || '0.3'}
                </span>
              </div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="tracking-tight whitespace-nowrap sm:hidden">
                          {thinkingMode === 'ultra' ? 'Ultra' : thinkingMode === 'basic' ? 'Think' : 'V3.0'}
                        </span>
                        {thinkingMode === 'ultra' && (
                        ...
                        {(thinkingMode === 'deep' || (deepThink && thinkingMode !== 'basic' && thinkingMode !== 'ultra')) && (
                          <span className="px-1.5 py-0.2 rounded text-[9px] font-mono font-bold tracking-wider bg-cyan-950/80 text-cyan-300 border border-cyan-500/50 whitespace-nowrap flex-shrink-0">
                            V3.0
                          </span>
                        )}
                        {(thinkingMode === 'basic' || thinkingMode === 'deep' || thinkingMode === 'ultra' || deepThink) && (
      ...
      <div className="mt-2.5 text-center text-[10.5px] text-zinc-500 font-mono tracking-tight flex items-center justify-center gap-2 select-none flex-wrap">
        <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-zinc-900/60 border border-white/[0.05]">
