...
import { loginUser, registerUser, checkHandleAvailability } from '../utils/auth';
...
export const AuthPortal: React.FC<AuthPortalProps> = ({ onAuthenticated }) => {
  ...
  // Handle Step 1 -> Step 2 progression
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#070709] text-white p-4 font-sans select-none overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md my-auto rounded-3xl bg-[#101014]/85 border border-zinc-800/80 shadow-[0_0_60px_rgba(0,0,0,0.8)] p-6 sm:p-8 backdrop-blur-2xl animate-fade-in">
        ...
        {/* Mode Switcher Tabs */}
        <div className="grid grid-cols-2 p-1 bg-zinc-900/90 rounded-xl border border-zinc-800 mb-5 text-xs font-mono">
          <button
            type="button"
        ...
        {mode === 'register' && (
          <div className="mb-5 p-2 rounded-xl bg-zinc-950/70 border border-zinc-800/80 font-mono text-[11px]">
        ...
        {mode === 'register' && registerStep === 1 && (
          <form onSubmit={handleProceedToStep2} className="space-y-4 text-xs font-mono">
            ...
            {/* Holographic Nixima ID Card Preview */}
            ...
            <button
              type="submit"
              disabled={cleanHandle.length < 3 || !availability.available}
          ...
          <form onSubmit={handleRegister} className="space-y-4 text-xs font-mono animate-fade-in">
            ...
            <div className="flex items-center gap-2 pt-2">
              ...
              <button
                ...
                className="flex-1 py-3 rounded-xl bg-white hover:bg-zinc-200 text-black font-bold text-xs uppercase tracking-wider transition-all duration-150 shadow-[0_0_20px_rgba(255,255,255,0.25)] flex items-center justify-center gap-2 group"
              >
                <NiximaIdLogo size={16} glow={false} className="group-hover:scale-110 transition-transform" />
