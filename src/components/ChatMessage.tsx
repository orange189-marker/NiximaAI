            ...
            <div className="space-y-3">
              ...
              {!isUser && message.searchGrounding && (
                <SearchActionFeed 
                  ...
                  highlightedSourceIdx={highlightedSourceIdx}
                />
              )}
      ...
      <div className="sticky top-0 z-20 flex items-center justify-between px-3.5 py-2 bg-[#121216]/95 backdrop-blur-md border-b border-zinc-800/80 rounded-t-xl text-[11px] font-mono text-zinc-400 select-none shadow-sm transition-all">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2.5">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2 py-1 rounded-md text-zinc-400 hover:text-white hover:bg-zinc-800/70 transition-colors cursor-pointer"
