...
export function resolveNiximaProfile(rawHandle: string): NiximaProfileData {
  ...
  if (cleanHandle === 'orange17') {
    return {
      ...
      neuralPrivileges: [
        ...
        'Search V3.1 Mega Swarm Protocol',
  ...
  if (cleanHandle === 'nixima' || cleanHandle === 'nixima-ai' || cleanHandle === 'ai' || cleanHandle === 'system') {
    return {
      ...
      bioEn: 'Central autonomous cognitive architecture powering the Nixima ecosystem. Coordinates multi-tiered reasoning (UltraThinking V1.0, Search V3.1 Mega Swarm, Canvas Engine).',
      bioUk: 'Центральна автономна когнітивна архітектура екосистеми Nixima. Керує багаторівневим мисленням (UltraThinking V1.0, Search V3.1 Mega Swarm, Canvas Engine).',
      securityProtocols: [
      ...
      neuralPrivileges: [
        ...
        'Sovereign Web Search V3.1 Swarm Protocol'
      ],
