...
export interface Translations {
  ...
  chatMessage: {
    ...
    searchV3Grounded: string;
    searchV3FastGrounded: string;
    searchV3MegaGrounded: string;
...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    chatInput: {
      ...
      deepThink: 'DeepThinking V3.0',
      deepThinkTooltip: 'DeepThinking V3.0: Activate multi-stage epistemic reasoning & proof verification',
      ...
      omniBadge: 'Omni Dual-Tool',
      omniTooltip: 'Nixima Omni: All-in-one sovereign model. Concurrent Dual-Tool architecture: DeepThinking reasoning and real-time WebSearch can execute simultaneously on demand.',
      search: 'Search V3.1',
      searchTooltip: 'Search V3.1: Real-time web mesh grounding & verified sources (min 20 websites)',
      searchFast: 'Fast',
      searchFastTooltip: 'Search V3.1 Fast: Ultra-low-latency real-time lookup (<50ms, 20 websites)',
      searchEngineTitle: 'Search V3.1 Grounding Engine',
      searchEngineSubtitle: 'Select search speed, depth & AI engine pairing',
      searchFastDesc: 'Sub-50ms instant live facts, headlines, and rapid snippet synthesis across 20 verified websites.',
      searchStandardDesc: 'Comprehensive multi-domain web grounding across 20+ websites with source verification & consensus.',
      searchMegaDesc: 'Exclusive Creator sovereign swarm scanning 50–80 websites across 7 deep knowledge clusters.',
    ...
    chatMessage: {
      ...
      searchV3Grounded: 'Search V3.1 Grounded (20+ Sites)',
      searchV3FastGrounded: 'Search V3.1 FAST Grounded (20 Sites)',
      searchV3MegaGrounded: 'Search V3.1 MEGA Swarm Grounded (50–80 Sites)',
      ...
      searchActionRadar: 'Search V3.1 Tool Actions & Live Reasoning',
  ...
  uk: {
    ...
    chatInput: {
      ...
      deepThink: 'DeepThinking V3.0',
      deepThinkTooltip: 'DeepThinking V3.0: Багатокрокове епістемічне міркування та верифікація логіки',
      deepThinkingV21: 'DeepThinking V2.1',
      ...
      omniBadge: 'Omni 2 Інструменти',
      omniTooltip: 'Nixima Omni: Суверенна модель «все-в-одному». Архітектура одночасного використання 2 інструментів: DeepThinking та Search V3.1 можуть працювати разом.',
      search: 'Search V3.1',
      searchTooltip: 'Search V3.1: Реальний веб-пошук у мережі та перевірені джерела (мін 20 сайтів)',
      searchFast: 'Швидкий',
      searchFastTooltip: 'Search V3.1 Fast: Надшвидкий пошук у реальному часі (<50мс, 20 сайтів)',
      searchEngineTitle: 'Пошуковий рушій Search V3.1',
      searchEngineSubtitle: 'Оберіть швидкість, глибину пошуку та пару AI-рушія',
      searchFastDesc: 'Миттєві факти, заголовки новин та оперативні витяги до 50мс по 20 верифікованих сайтах.',
      searchStandardDesc: 'Глибокий багатодоменний веб-пошук по 20+ сайтах зі збалансованим синтезом джерел.',
      searchMegaDesc: 'Ексклюзивний режим Творця: суверенний пошуковий рій по 50–80 сайтах у 7 кластерах знань.',
    ...
    chatMessage: {
      ...
      searchV3Grounded: 'Search V3.1 Верифіковано (20+ сайтів)',
      searchV3FastGrounded: 'Search V3.1 FAST Верифіковано (20 сайтів)',
      searchV3MegaGrounded: 'Search V3.1 MEGA Swarm Верифіковано (50–80 сайтів)',
      ...
      searchActionRadar: 'Дії та жива аргументація інструменту Search V3.1',
