...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    chatInput: {
      ...
      search: 'Search V3',
      searchTooltip: 'Search V3: Real-time web mesh grounding & verified sources (min 20 websites)',
      searchFast: 'Fast',
      searchFastTooltip: 'Search V3 Fast: Ultra-low-latency real-time lookup (<50ms, 20 websites)',
      searchEngineTitle: 'Search V3 Grounding Engine',
    ...
    chatMessage: {
      ...
      searchV3Grounded: 'Search V3 Grounded (20+ Sites)',
      searchV3FastGrounded: 'Search V3 FAST Grounded (20 Sites)',
      searchV3MegaGrounded: 'Search V3 MEGA Swarm Grounded (50–80 Sites)',
      ...
      searchActionRadar: 'Search V3 Tool Actions & Live Reasoning',
  ...
  uk: {
    ...
    chatInput: {
      ...
      omniTooltip: 'Nixima Omni: Суверенна модель «все-в-одному». Архітектура одночасного використання 2 інструментів: DeepThinking та Search V3 можуть працювати разом.',
      search: 'Search V3',
      searchTooltip: 'Search V3: Реальний веб-пошук у мережі та перевірені джерела (мін 20 сайтів)',
      searchFast: 'Швидкий',
      searchFastTooltip: 'Search V3 Fast: Надшвидкий пошук у реальному часі (<50мс, 20 сайтів)',
      searchEngineTitle: 'Пошуковий рушій Search V3',
    ...
    chatMessage: {
      ...
      searchV3Grounded: 'Search V3 Верифіковано (20+ сайтів)',
      searchV3FastGrounded: 'Search V3 FAST Верифіковано (20 сайтів)',
      searchV3MegaGrounded: 'Search V3 MEGA Swarm Верифіковано (50–80 сайтів)',
      ...
      searchActionRadar: 'Дії та жива аргументація інструменту Search V3',
